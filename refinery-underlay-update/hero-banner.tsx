...
const banners: Banner[] = [
  {
    ...
    theme: 'company',
    items: ['factory', 'drum', 'glycerine', 'truck', 'soap'],
    artworkAlt: 'Illustration of an industrial processing plant, delivery truck, chemical drum, glycerine vessel and soap noodles representing industrial chemical distribution.',
    duration: 6000,
  },
  {
...
const defaultArtworkFiles = [...new Set(banners[0].items.map(item => artworkLayers[item].file))];
