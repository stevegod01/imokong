...
const banners: Banner[] = [
  ...
  },
  {
    ...
    artworkAlt: 'Three industrial drums: Glycerine in white lettering between horizontal rules, Paint Making Solvents on a broad white band, and Stearic Acid on a compact white product label.',
  },
  {
    name: 'Food products',
