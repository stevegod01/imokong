...
export default function About(){return <main id="main"><section className="wrap inner-page">
  ...
  <div className={styles.hero}>
    <div className={styles.heroCopy}>
      <p className="eyebrow">GET TO KNOW IMOKO</p>
      <h1>The right partner.<br/><em>More possibilities.</em></h1>
      <p className={styles.storyLead}>Supporting Nigerian industry. Bringing value to everyday life.</p>
      <div className={styles.introduction}>
        <p>IMOKO manufactures, imports and distributes household commodities across Nigeria, serving businesses and reaching consumers through major retail stores. Our focus is quality, customer wellbeing and value for money.</p>
        <p>Alongside our food and consumer products, we supply industrial inputs for soap production and other manufacturing applications. Our range includes soap noodles, distilled palm-based fatty acids, glycerine, stearic acid and paint-making solvents.</p>
        <Link className="text-link" href="/products">Discover our products <ArrowUpRight size={18}/></Link>
      </div>
    </div>
  ...
  <section id="industrial-partnership" className={styles.partnership} aria-labelledby="partnership-heading"><div><p className="eyebrow">OUR INDUSTRIAL PARTNERSHIP</p><h2 id="partnership-heading" className="display-heading">International production.<br/>Local market knowledge</h2></div><div><p>Our exclusive strategic partnership with production partners in Pakistan connects Nigerian manufacturers to soap-making materials at source. We combine that manufacturing relationship with local procurement and supply-chain knowledge.</p><p>For soap producers, this includes formulation and research collaboration around total fatty matter, moisture content, skin feel and fragrance requirements.</p><Link className="text-link" href="/partners">Explore our partnerships <ArrowUpRight size={18}/></Link></div></section>
