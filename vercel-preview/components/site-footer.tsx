      ...
      <div className="wrap">
        <div className="imoko-footer-main">
          ...
          <nav aria-label="Footer company">
            ...
            <Link href="/leadership/board-of-directors">Board of directors</Link>
            <Link href="/leadership/executive-management">Executive management</Link>
          ...
          <div className="imoko-footer-contact">
            ...
            <div className="imoko-footer-detail"><Phone size={18} aria-hidden="true" /><div><a href="tel:+2347062935109">+234 706 293 5109</a><a href="tel:+2347018529708">+234 701 852 9708</a></div></div>
