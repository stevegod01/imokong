...
Only the company introduction slide uses the new branding and bag. The existing transparent IMOKO logo is composed as a white-backed decal on the truck's orange side panel and the chemical drum's orange band. Each decal lives inside the same animated wrapper as its object, so it follows every movement.
