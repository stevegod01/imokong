...
type BannerArtwork = ArtworkKey | { kind: ArtworkKey; label: string };
...
const banners: Banner[] = [
  ...
  },
  {
    ...
    theme: 'industrial',
    items: [
      { kind: 'drum', label: 'Glycerine' },
      { kind: 'drum', label: 'Paint solvent' },
      { kind: 'drum', label: 'Stearic acid' },
    ],
    artworkAlt: 'Three industrial drums labelled Glycerine, Paint solvent and Stearic acid.',
  },
  {
    name: 'Food products',
