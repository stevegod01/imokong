  ...
  return <main id="main" className="wrap inner-page granola-page">
    ...
    <section className="granola-hero">
      ...
      <div className="granola-lead"><p className="eyebrow">NICNAX GRANOLA</p><h1>A little crunch.<br/><em>More to enjoy.</em></h1>
        <p className="intro">Oat-based granola for breakfast bowls, yoghurt toppings and everyday snacking. Explore the Nicnax flavours for your shelves, menus and customers.</p>
    ...
    <section id="granola-flavours" className="granola-section">
      ...
      <div className="granola-packaging"><figure><img src="/images/granola-detail/range.jpg" alt="Nicnax granola retail packs, an outer carton and Nutee peanut butter jars" width={1180} height={626} loading="lazy"/><figcaption>Retail packs and outer-carton presentation.</figcaption></figure>
    ...
    <section className="granola-pairing"><img src="/images/granola-detail/nutee.jpg" alt="Two jars of Nutee smooth peanut butter with peanuts" width={348} height={348} loading="lazy"/><div><p className="eyebrow">ALONGSIDE YOUR GRANOLA</p><h2 className="display-heading">Meet Nutee.</h2><p>The smooth peanut butter pictured alongside the Nicnax range offers another way to build a breakfast or snack selection. Ask about Nutee when discussing your granola order.</p><Link className="text-link" href="/contact?product=Granola&variant=Nutee%20peanut%20butter%20enquiry">Ask about Nutee <ArrowUpRight size={17}/></Link></div></section>
